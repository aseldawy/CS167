...
2. Add the following dependency to your `pom.xml` file.
    ...
    ```
    Your pom.xml file must include <spark.version>3.5.4</spark.version> in the properties. It must also include  `spark-sql` similar to Lab 6.
---
...
3. (`TODO A`) Load the file input file `sentiment.csv` as a CSV file using the following options.
    ...
    Hint: See [Lab 6](../Lab6/CS167-Lab6.md#iii-read-and-parse-the-input-file-part-b-10-minutes-in-home)
